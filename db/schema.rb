...
ActiveRecord::Schema[7.0].define(version: 2022_10_12_043918) do
  ...
  create_table "inventoris", force: :cascade do |t|
    t.string "name"
    t.string "description"
    t.bigint "user_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["user_id"], name: "index_inventoris_on_user_id"
  end
  ...
  add_foreign_key "inventoris", "users"
  add_foreign_key "inventory_foods", "foods"
  add_foreign_key "inventory_foods", "inventoris", column: "inventory_id"
